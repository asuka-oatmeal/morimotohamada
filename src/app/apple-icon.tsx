      ...
      >
        ...
        >
          <g transform="translate(256,260)">
            ...
            <line x1="105" y1="-86" x2="105" y2="10" stroke="#c9a84c" stroke-width="6"/>
            <line x1="140" y1="-86" x2="140" y2="10" stroke="#c9a84c" stroke-width="6"/>
            <path d="M-178,10 C-178,38 -166,56 -122,56 C-78,56 -66,38 -66,10" stroke="#c9a84c" stroke-width="7" fill="none"/>
            <ellipse cx="-122" cy="10" rx="56" ry="6" stroke="#c9a84c" stroke-width="7" fill="none"/>
            <path d="M66,10 C66,38 78,56 122,56 C166,56 178,38 178,10" stroke="#c9a84c" stroke-width="7" fill="none"/>
            <ellipse cx="122" cy="10" rx="56" ry="6" stroke="#c9a84c" stroke-width="7" fill="none"/>
          </g>
        </svg>
      </div>
